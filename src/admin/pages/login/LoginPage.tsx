  ...
  return (
    <div className="min-h-screen flex bg-[#F8F7F4]">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] flex-shrink-0 bg-[#111110] p-10">
        <img src="/brand/holistic-edge-logo-transparent.png" alt="Holistic Edge" className="h-14 sm:h-16 w-auto object-contain self-start brightness-[1.2]" />
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex justify-center mb-8">
            <img src="/brand/holistic-edge-logo-transparent.png" alt="Holistic Edge" className="h-14 w-auto object-contain" />
          </div>
